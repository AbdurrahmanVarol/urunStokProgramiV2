...
{
    public partial class frmDecrease : Form
    {
        public frmDecrease()
        {
            InitializeComponent();
        ...
        private void frmDecrease_Load(object sender, EventArgs e)
        {
        ...
        private void btnAdetAzalt_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count == 1)
            {
                if (listView1.SelectedItems[0].SubItems[6].Text == "-")
                {
                    ...
                    if (urun.UrunAdet - Convert.ToInt32(tbxUrunAdet.Texts) >= 0)
                    {
                        urun.UrunAdet -= Convert.ToInt32(tbxUrunAdet.Texts);
                        _urunManager.Update(urun);
                        MessageBox.Show(urun.UrunAd + " Adlı ürünün adet miktartı " + tbxUrunAdet.Texts + " kadar azaltıldı.");
                        ...
                        Log log = new Log
                        {
                            ...
                            Islem = "Adet miktarı azaltıldı: " + tbxUrunAdet.Texts,
                        ...
                        MessageBox.Show("Ürünün adet miktarından fazla azaltma işlemi yapamazsınız.");
                }
                else
                {
        ...
        private void btnStokAzalt_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count == 1)
            {
                if (listView1.SelectedItems[0].SubItems[6].Text == "-")
                {
                    ...
                    if (urun.StokMiktari - Convert.ToInt32(tbxStokAdet.Texts) >= 0)
                    {
                        urun.StokMiktari -= Convert.ToInt32(tbxStokAdet.Texts);
                        _urunManager.Update(urun);
                        MessageBox.Show(urun.UrunAd + " Adlı ürünün Stok miktartı " + tbxUrunAdet.Texts + " kadar azaltıldı.");
                        Timer timer = new Timer();
                        timer.Start();
                        Log log = new Log
                        {
                            ...
                            KullaniciAd = frmLogin._kullanici.KullaniciAdi,
                            YetkiId = frmLogin._kullanici.KullaniciYetki,
                            Islem = "Stok miktarı azaltıldı: " + tbxUrunAdet.Texts,
                            Tarih = DateTime.Now.ToString()
                        };
                        timer.Stop();
                        _logManager.Add(log);
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Ürün Silinecek.\n Emin misiniz ?", "Ürün Silme", MessageBoxButtons.YesNo);
            if (dialogResult == DialogResult.Yes)
            {
                if (listView1.SelectedItems[0].SubItems[6].Text == "-")
                    _urunManager.Delete(Convert.ToInt32(listView1.SelectedItems[0].SubItems[0].Text));
                else
                    _urunKutuManager.Delete(Convert.ToInt32(listView1.SelectedItems[0].SubItems[0].Text));
